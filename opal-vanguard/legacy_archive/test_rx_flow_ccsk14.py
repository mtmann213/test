...
class test_tb(gr.top_block):
    def __init__(self):
        ...
        # A burst of CCSK is 54560 bits (6820 packed bytes).
        # We unpack to 54560 bits.
        # chunks_to_symbols outputs 54560 complex items.
        # interpolation outputs 545600 complex items.
        # But our packetizer output `burst` is the packed bytes (length 6820).
        ...
        # Add mult_len to see if it causes issues downstream (it shouldn't in sim, but let's see)
