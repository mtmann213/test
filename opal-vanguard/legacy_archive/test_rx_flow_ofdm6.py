...
class test_tb(gr.top_block):
    def __init__(self):
        ...
        # Buffer isolation
        self.tx_copy = blocks.copy(gr.sizeof_gr_complex)
        self.tx_copy.set_max_output_buffer(131072)
        self.rx_copy = blocks.copy(gr.sizeof_gr_complex)
        self.rx_copy.set_max_output_buffer(131072)
        
        self.msg_connect((self.src, "strobe"), (self.p2s, "pdus"))
        self.connect(self.p2s, self.tx, self.tx_copy, self.chan, self.rx_copy, self.rx, self.depkt, self.null_snk)
