...
if __name__ == '__main__':
    ...
    time.sleep(1)
    tb.stop(); tb.wait()
    if tb.success: print("\033[92m[PASS]\033[0m Ultimate Level 7 Logic Integrity Confirmed.")
    else: print("\033[91m[FAIL]\033[0m Level 7 logic is STILL broken."); sys.exit(1)
