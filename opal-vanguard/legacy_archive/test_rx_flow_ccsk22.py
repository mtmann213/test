...
p = MockPacketizer()
msg_str = b"HEARTBEAT FROM ALPHA"
...
class test_tb(gr.top_block):
    def __init__(self):
        ...
        # Test with heavy noise and large frequency offset typical of real hardware
        self.chan = channels.channel_model(noise_voltage=0.4, frequency_offset=0.01)
