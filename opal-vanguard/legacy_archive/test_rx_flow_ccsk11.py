...
p = MockPacketizer()
# Test with HEARTBEAT from ALPHA to see if encryption/CCSK handles the exact length
...
class test_tb(gr.top_block):
    def __init__(self):
        ...
        # Hardware simulation with timing offset
        self.chan = channels.channel_model(noise_voltage=0.01, time_offset=1.0001)
