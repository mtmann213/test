...
class test_tb(gr.top_block):
    def __init__(self):
        ...
        # Test with REAL WORLD noise and a large phase offset to see if costas breaks
        self.chan = channels.channel_model(noise_voltage=0.2, frequency_offset=0.01, epsilon=1.0001)
        ...
        # INCREASE COSTAS LOOP BANDWIDTH for real world offset?
